...
pais_eleg = int(input("Elige al pais que quieres viajar del 1 al 5\n\n"))
...
print("\nYa sabemos que estas interesado en viajar al pais de", list_paises[index_pais], ". Ahora dinos de que presupuesto dispones o disponeis (para alimentacion, alojamiento, para transporte,ocio)\n\n")
...
presupuesto = presupuesto_alimentacion +presupuesto_alojamiento + presupuesto_transporte + presupuesto_transporte
...
print("\n\nUsted puede corroborar cuantos panes puede comprar con el presupuesto total , el tipo de cambio y el preci del pan en cada destino. Así podrás ver cual es poder adquisitivo en cada pais por el tipo de cambio y precio del pan:\n\n")
